...
- JDK 11
- Android uređaj ili emulator sa API level 29+ (Android 10+)
- Internet konekcija
...
3. Sačekati da Gradle sinhronizuje zavisnosti
4. Pokrenuti aplikaciju klikom na Run

Napomena: google-services.json je uključen u projekat, Firebase nije potrebno dodatno podešavati.

## Pokretanje na fizičkom uređaju

1. Na telefonu: Podešavanja > O telefonu > Broj verzije, kliknuti 7 puta
2. Podešavanja > Sistem > Opcije za programere > USB debagovanje, uključiti
3. Povezati telefon sa računarom putem USB kabla
4. U Android Studio-u izabrati uređaj i kliknuti Run
...
Napomena: Za testiranje popup notifikacija preporučuje se emulator sa API 33+.
...
- Skočko (2 x 30s, max 40 bodova)
- Korak po korak (2 x 70s, max 40 bodova)
- Moj broj (2 x 1 min, max 20 bodova)

## Notifikacije

Aplikacija koristi 4 kanala: čet, rangiranje, nagrade i ostalo. Istorija notifikacija dostupna je klikom na zvono u zaglavlju. Notifikacije se mogu označiti kao pročitane i filtrirati.
